 ...
 */
int put_json_node(char *jsonBuffer, size_t sizeOfBuffer, const char *pKey,
                  void *pData, JsonDataType type);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int event_put_json_node(char *jsonBuffer, size_t sizeOfBuffer, const char *pKey,
                        void *pData, JsonDataType type);
...
int generate_client_token(char *pStrBuffer, size_t sizeOfBuffer,
                          uint32_t *tokenNumber, char *product_id);
