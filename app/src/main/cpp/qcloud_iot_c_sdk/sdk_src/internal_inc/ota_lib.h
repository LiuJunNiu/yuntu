 ...
 */
int qcloud_otalib_get_params(const char *json, char **type, char **url,
                             char **version, char *md5, uint32_t *fileSize);
 ...
 * @return          QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int qcloud_otalib_gen_info_msg(char *buf, size_t bufLen, uint32_t id,
                               const char *version);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int qcloud_otalib_gen_report_msg(char *buf, size_t bufLen, uint32_t id,
