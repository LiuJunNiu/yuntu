...
#define UTILS_ERR_PLATFORM_HW_ACCEL_FAILED \
    -0x0070 /**< Hardware accelerator failed */
#define UTILS_ERR_PLATFORM_FEATURE_UNSUPPORTED \
...
#define UTILS_ERR_AES_INVALID_INPUT_LENGTH \
...
#define UTILS_ERR_AES_HW_ACCEL_FAILED \
 ...
 * \return         \c 0 on success.
 */
int utils_aes_crypt_ecb(utils_aes_context *ctx, int mode,
 ...
 *                 on failure.
 */
int utils_aes_crypt_cbc(utils_aes_context *ctx, int mode, size_t length,
...
int utils_aes_cbc(uint8_t *pInData, uint32_t datalen, uint8_t *pOutData,
                  uint32_t outBuffLen, uint8_t mode, uint8_t *pKey,
