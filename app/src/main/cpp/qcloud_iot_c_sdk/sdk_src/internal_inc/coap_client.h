...
#define COAP_MSG_IS_EMPTY(message) \
    (((message)->code_class == 0) && ((message)->code_detail == 0))

/* If COAP msg is empty ACK */
#define COAP_MSG_IS_EMPTY_ACK(message) \
    (((message)->code_class == 2) && ((message)->code_detail == 3))

/* If COAP msg is RESP */
#define COAP_MSG_IS_EMPTY_RSP(message) \
    (((message)->code_class == 2) && ((message)->code_detail == 5))
...
typedef enum {
    ...
    COAP_MSG_CODE_201_CREATED =
        01, /* Mapping to CoAP codeClass.codeDetail 2.01 */
    COAP_MSG_CODE_202_DELETED =
        02, /* Mapping to CoAP codeClass.codeDetail 2.02 */
    COAP_MSG_CODE_203_VALID =
        03, /* Mapping to CoAP codeClass.codeDetail 2.03 */
    COAP_MSG_CODE_204_CHANGED =
        04, /* Mapping to CoAP codeClass.codeDetail 2.04 */
    COAP_MSG_CODE_205_CONTENT =
        05, /* Mapping to CoAP codeClass.codeDetail 2.05 */
    COAP_MSG_CODE_231_CONTINUE =
        31, /* Mapping to CoAP codeClass.codeDetail 2.31 */

    /* CoAP Client Error Response code detail */
    COAP_MSG_CODE_400_BAD_REQUEST =
        00, /* Mapping to CoAP codeClass.codeDetail 4.00 */
    COAP_MSG_CODE_401_UNAUTHORIZED =
        01, /* Mapping to CoAP codeClass.codeDetail 4.01 */
    COAP_MSG_CODE_402_BAD_OPTION =
        02, /* Mapping to CoAP codeClass.codeDetail 4.02 */
    COAP_MSG_CODE_403_FORBIDDEN =
        03, /* Mapping to CoAP codeClass.codeDetail 4.03 */
    COAP_MSG_CODE_404_NOT_FOUND =
        04, /* Mapping to CoAP codeClass.codeDetail 4.04 */
    COAP_MSG_CODE_405_METHOD_NOT_ALLOWED =
        05, /* Mapping to CoAP codeClass.codeDetail 4.05 */
    COAP_MSG_CODE_406_NOT_ACCEPTABLE =
        06, /* Mapping to CoAP codeClass.codeDetail 4.06 */
    COAP_MSG_CODE_408_REQUEST_ENTITY_INCOMPLETE =
        8, /* Mapping to CoAP codeClass.codeDetail 4.08 */
    COAP_MSG_CODE_412_PRECONDITION_FAILED =
        12, /* Mapping to CoAP codeClass.codeDetail 4.12 */
    COAP_MSG_CODE_413_REQUEST_ENTITY_TOO_LARGE =
        13, /* Mapping to CoAP codeClass.codeDetail 4.13 */
    COAP_MSG_CODE_415_UNSUPPORTED_CONTENT_FORMAT =
        15, /* Mapping to CoAP codeClass.codeDetail 4.15 */

    /* CoAP Server Error Response code detail */
    COAP_MSG_CODE_500_INTERNAL_SERVER_ERROR =
        00, /* Mapping to CoAP codeClass.codeDetail 5.00 */
    COAP_MSG_CODE_501_NOT_IMPLEMENTED =
        01, /* Mapping to CoAP codeClass.codeDetail 5.01 */
    COAP_MSG_CODE_502_BAD_GATEWAY =
        02, /* Mapping to CoAP codeClass.codeDetail 5.02 */
    COAP_MSG_CODE_503_SERVICE_UNAVAILABLE =
        03, /* Mapping to CoAP codeClass.codeDetail 5.03 */
    COAP_MSG_CODE_504_GATEWAY_TIMEOUT =
        04, /* Mapping to CoAP codeClass.codeDetail 5.04 */
    COAP_MSG_CODE_505_PROXYING_NOT_SUPPORTED =
        05, /* Mapping to CoAP codeClass.codeDetail 5.05 */
    COAP_MSG_CODE_600_TIMEOUT =
        00, /* Mapping to self define CoAP codeClass.codeDetail 6.00 */
} CoAPRespCodeDetail;
...
#define DEFAULT_COAP_MESSAGE                                                 \
    {                                                                        \
        COAP_MSG_VER, COAP_MSG_CON, COAP_MSG_REQ, COAP_MSG_POST, 0, NULL, 0, \
            {0}, 0, {0}, NULL, NULL                                          \
    }
 ...
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int coap_message_option_add(CoAPMessage *message, unsigned num, unsigned len,
                            const char *val);
 ...
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
CoAPMsgOption *qcloud_iot_coap_option_init(unsigned num, unsigned len,
                                           const char *val);
