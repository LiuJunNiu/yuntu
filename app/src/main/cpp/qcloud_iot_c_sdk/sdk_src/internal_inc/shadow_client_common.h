 ...
 */
int shadow_common_register_property_on_delta(Qcloud_IoT_Shadow *pShadow,
 ...
 * @return          QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int shadow_common_remove_property(Qcloud_IoT_Shadow *pshadow,
                                  DeviceProperty *   pProperty);
 ...
 */
int shadow_common_check_property_existence(Qcloud_IoT_Shadow *pshadow,
                                           DeviceProperty *   pProperty);
