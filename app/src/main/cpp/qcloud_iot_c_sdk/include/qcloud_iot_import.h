 ...
 */
int HAL_Vsnprintf(_OU_ char *str, _IN_ const int len, _IN_ const char *fmt,
                  _IN_ va_list ap);
 ...
 */
struct Timer {
#if defined(OS_ANDROID) || (defined(__linux__) && defined(__GLIBC__))
...
int       HAL_AT_TCP_Write(uintptr_t fd, const unsigned char *buf, uint32_t len,
                           uint32_t timeout_ms, size_t *written_len);
int       HAL_AT_TCP_Read(uintptr_t fd, uint8_t *buf, uint32_t len,
                          uint32_t timeout_ms, uint32_t *read_len);
int       at_device_init(void);
int       HAL_AT_Uart_Init(void);
int       HAL_AT_Uart_Deinit(void);
int       HAL_AT_Uart_Send(void *data, uint32_t size);
int HAL_AT_Uart_Recv(void *data, uint32_t expect_size, uint32_t *recv_size,
                     uint32_t timeout);
#endif
 ...
 */
uintptr_t HAL_TLS_Connect(TLSConnectParams *pConnectParams, const char *host,
                          int port);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_TLS_Write(uintptr_t handle, unsigned char *data, size_t totalLen,
                  uint32_t timeout_ms, size_t *written_len);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_TLS_Read(uintptr_t handle, unsigned char *data, size_t totalLen,
 ...
 */
uintptr_t HAL_DTLS_Connect(DTLSConnectParams *pConnectParams, const char *host,
                           int port);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_DTLS_Write(uintptr_t handle, const unsigned char *data, size_t datalen,
                   size_t *written_len);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_DTLS_Read(uintptr_t handle, unsigned char *data, size_t datalen,
                  uint32_t timeout_ms, size_t *read_len);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_TCP_Write(uintptr_t fd, const unsigned char *data, uint32_t len,
                  uint32_t timeout_ms, size_t *written_len);
 ...
 * @return              QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int HAL_TCP_Read(uintptr_t fd, unsigned char *data, uint32_t len,
                 uint32_t timeout_ms, size_t *read_len);
 ...
 * failure
 */
int HAL_UDP_ReadTimeout(uintptr_t fd, unsigned char *p_data,
