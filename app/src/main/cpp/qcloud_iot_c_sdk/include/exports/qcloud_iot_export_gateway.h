 ...
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int IOT_Gateway_Subdev_Bind(void *client, GatewayParam *param,
                            DeviceInfo *pBindSubDevInfo);
 ...
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int IOT_Gateway_Subdev_Unbind(void *client, GatewayParam *param,
                              DeviceInfo *pSubDevInfo);
 ...
 * @return packet id (>=0) when success, or err code (<0) for failure
 */
int IOT_Gateway_Subscribe(void *client, char *topic_filter,
 ...
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
int IOT_Gateway_Subdev_GetBindList(void *client, GatewayParam *param,
                                   SubdevBindList *subdev_bindlist);

/**
 * @brief destory sub dev bind list
 *
 * @param subdev_bindlist  input subdev bind list pointer, ref
 * IOT_Gateway_Subdev_GetBindList output param subdev_bindlist
 *
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
