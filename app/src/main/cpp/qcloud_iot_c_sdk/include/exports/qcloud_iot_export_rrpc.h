 ...
 */
typedef void (*OnRRPCMessageCallback)(void *pClient, const char *msg,
                                      uint32_t msgLen);
 ...
 * for failure
 */
int IOT_RRPC_Reply(void *pClient, char *pJsonDoc, size_t sizeOfBuffer,
                   sRRPCReplyPara *replyPara);
