 ...
 * memory/application context) Adjust the default value to meet your requirement
 */

/* default MQTT/CoAP timeout value when connect/pub/sub (unit: ms) */
#define QCLOUD_IOT_MQTT_COMMAND_TIMEOUT (60 * 1000)

/* default MQTT keep alive interval (unit: ms) */
#define QCLOUD_IOT_MQTT_KEEP_ALIVE_INTERNAL (20 * 1000)
 ...
 * consumption the default value can be changed for different user situation
 */
